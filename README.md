...
Whether you are new to Pulumi or a seasoned user, Deskypus aims to simplify your local Pulumi experience.
...
- No analytics whatsoever. There is not even an optional opt-in setting.

Go to https://deskypus.cloudysky.software to learn more and download the app or download directly from the [releases](https://github.com/deskypus/app/releases) page.
